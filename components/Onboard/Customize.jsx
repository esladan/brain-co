        ...
        <div className="flex justify-center">
            <form method="post" className={`bg-medium rounded p-5 mt-10 w-10/12 sm:w-4/12`}>
                ...
                <div className="text-center">
                    ...
                    <button data-level='1' className="mt-8 w-8/12 py-3 rounded-sm bg-orange cont ">Turn on notifications</button>
                    <button data-level='2' className="my-1 w-8/12 py-3 rounded-sm cont ">Skip</button>
